...
import BookCover from '../components/component/book-detail/BookCover';
  ...
  return (
    <>
      <div className="flex min-h-screen flex-col items-center justify-center">
        <div className="relative ml-[900px] h-[700px] w-[1000px] perspective-[2000px]">
          <BookCover
            isOpen={isOpen}
            onClick={handleOpen}
            bookCover={bookDetail[0].cover}
          />
        </div>
